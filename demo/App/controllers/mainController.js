...
exports.getProfilePage = async(req, res, next) => {
    ...
    try {
        profile = await fetchManager.callAPI(appSettings.remoteResources.graphAPI.endpoint, req.session.resources.remoteResources["graphAPI"].accessToken);
...
exports.getTenantPage = async(req, res, next) => {
    ...
    try {
        tenant = await fetchManager.callAPI(appSettings.remoteResources.armAPI.endpoint, req.session.resources.remoteResources["armAPI"].accessToken);
