...
function IsAnInteractionRequiredAuthError(error) {
  return msalCommon.InteractionRequiredAuthError.isInteractionRequiredError(error == null ? void 0 : error.errorCode, error == null ? void 0 : error.errorMessage, error == null ? void 0 : error.subError);
}
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 17:
                ...
                if (!(_context3.t0 instanceof msalCommon.InteractionRequiredAuthError || IsAnInteractionRequiredAuthError(_context3.t0))) {
                  _context3.next = 26;
                  break;
                }
