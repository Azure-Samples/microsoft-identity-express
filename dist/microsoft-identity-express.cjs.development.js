          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                state = JSON.parse(_this5.cryptoUtils.decryptData(_this5.cryptoProvider.base64Decode(req.query.state), Buffer.from(req.session.cryptoKey, "hex"))); // check if nonce matches
