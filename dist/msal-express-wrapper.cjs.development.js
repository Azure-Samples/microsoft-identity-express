  ...
  ConfigurationBuilder.getMsalConfiguration = function getMsalConfiguration(config, cachePlugin) {
    ...
    return {
      auth: _extends({
        ...
        : config.appCredentials.instance ? "https://" + config.appCredentials.instance + "/" + config.appCredentials.tenantInfo : "https://" + msalCommon.Constants.DEFAULT_AUTHORITY_HOST + "/" + config.appCredentials.tenantInfo
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = _context2.t0 === AppStages.SIGN_IN ? 6 : _context2.t0 === AppStages.ACQUIRE_TOKEN ? 29 : 44;
                break;
